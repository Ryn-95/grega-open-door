          ...
          <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
            ...
            >
              <div className="mb-8">
                ...
                >
                  <img src="/3D/Newsletter.png" alt="Newsletter" className="w-full h-full object-contain" />
                  <motion.div
                    animate={{ 
                      scale: [1, 1.1, 1],
                      opacity: [0.5, 0.8, 0.5] 
              ...
              <h2 className="text-4xl font-extralight mb-6">
                Newsletter <span className="font-normal">Immobilière</span>
              </h2>
              <p className="text-xl text-slate-300 font-light mb-8 max-w-3xl mx-auto leading-relaxed">
                Rejoignez <span className="text-white font-medium">47 842 professionnels</span> qui reçoivent chaque semaine nos analyses exclusives, 
                opportunités de marché et conseils d'experts. 
                <span className="block mt-2 text-lg">🎁 <strong>Bonus :</strong> Guide PDF de 120 pages offert à l'inscription</span>
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto mb-8">
                <input
                  ...
                  className="flex-1 px-6 py-4 rounded-xl bg-white/10 backdrop-blur-lg border border-white/20 text-white placeholder:text-slate-300 focus:outline-none focus:border-white/40 focus:bg-white/15 transition-all"
                />
                <button className="px-8 py-4 bg-white text-slate-900 rounded-xl font-medium hover:bg-slate-100 transition-colors flex items-center justify-center gap-2 whitespace-nowrap">
                  <span>S'abonner</span>
                  <FaArrowRight className="w-3 h-3" />
                </button>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto">
                {[
                  { icon: "📊", text: "Analyses de marché exclusives" },
                  { icon: "🎯", text: "Opportunités d'investissement" },
                  { icon: "🔒", text: "Aucun spam, désabonnement 1 clic" }
                ].map((item, index) => (
