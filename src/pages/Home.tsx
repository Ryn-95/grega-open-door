...
const Home = () => {
  const faqData = [
    {
      question: "Combien de temps faut-il pour trouver un appartement à Paris ?",
      answer: "Avec GREGA OPEN DOOR, trouvez votre appartement en moyenne en 7 jours ! Nous organisons vos visites sous 24h et optimisons votre dossier pour maximiser vos chances d'acceptation. Le marché parisien est tendu mais notre expertise accélère le processus."
    },
    {
  ...
  return (
    <>
      <SEOHead
        title="Trouvez votre Appartement en 3 Clics | GREGA OPEN DOOR - Location Paris Rapide 2025"
        description="🏠 Trouvez votre appartement Paris en moins de 7 jours ! GREGA OPEN DOOR : 500+ biens disponibles, visites organisées 24h, dossier optimisé. Évitez les arnaques location. ☎️ 09 53 37 61 41"
