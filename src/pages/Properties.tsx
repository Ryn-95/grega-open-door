...
import { FaMapMarkerAlt, FaRulerCombined, FaBed, FaSearch, FaFilter, FaEuroSign } from 'react-icons/fa';
...
const Properties = () => {
  const properties = [
    ...
    },
    {
      id: 4,
      title: "Loft Design",
      description: "Loft d'architecte avec volumes exceptionnels",
      price: "550,000 €",
      location: "Paris 11ème",
      surface: "140m²",
      rooms: "3",
      image: "/images/property4.jpg",
      features: ["Double hauteur", "Verrière", "Cave à vin"]
    }
  ];
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-black to-gray-900 pt-32">
      {/* Hero Section */}
            ...
            <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-8 md:p-12">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Affinez votre recherche selon vos critères</p>
                </div>
              </div>
                  ...
                  <div className="relative aspect-[4/3] overflow-hidden">
                    ...
                    <div className="absolute top-4 right-4 bg-black/80 backdrop-blur-sm px-4 py-2 rounded-full">
                      <span className="text-sm font-medium flex items-center gap-1">
                        <FaEuroSign className="text-white/50" />
                        {property.price}
                      </span>
                    </div>
                  </div>
